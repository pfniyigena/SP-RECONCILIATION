...
public class CustomerController {
    ...
    public String newForm(Model model) {
        addFormToModel(model, CustomerForm.builder().build());
    ...
    public String create(@Valid @ModelAttribute("form") CustomerForm form,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("flashMessage", "Customer created.");
    ...
    public String delete(@PathVariable UUID id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("flashMessage", deleted
                ? "Customer deleted."
                : "Can't delete this customer — one or more transactions still reference them.");
