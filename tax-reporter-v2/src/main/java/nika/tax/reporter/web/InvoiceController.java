...
public class InvoiceController {
    ...
    public String newForm(Model model) {
        addFormToModel(model, TaxReporterInvoiceForm.builder().build());
        model.addAttribute("isEdit", false);
        return "invoice-form";
    }

    @PostMapping
    public String create(@Valid @ModelAttribute("form") TaxReporterInvoiceForm form,
        ...
        try {
            TaxReporterInvoice saved = invoiceService.create(form);
            redirectAttributes.addFlashAttribute("flashMessage", "Invoice created.");
