...
public class UserController {
    ...
    public String delete(@PathVariable UUID id, Authentication authentication, RedirectAttributes redirectAttributes) {
        String refusalReason = appUserService.delete(id, authentication.getName());
        redirectAttributes.addFlashAttribute("flashMessage", refusalReason != null ? refusalReason : "User deleted.");
        return "redirect:/users";
    }
