...
public class TerminalMachineController {
    ...
    public String newForm(Model model) {
        addFormToModel(model, TerminalMachineForm.builder().build());
    ...
    @PostMapping
    public String create(@Valid @ModelAttribute("form") TerminalMachineForm form,
        ...
        TerminalMachine saved = terminalMachineService.create(form);
        redirectAttributes.addFlashAttribute("flashMessage", "Terminal machine created.");
        return "redirect:/machines/" + saved.getId() + "/edit";
    }
    ...
    public String delete(@PathVariable UUID id, RedirectAttributes redirectAttributes) {
        boolean deleted = terminalMachineService.delete(id);
        redirectAttributes.addFlashAttribute("flashMessage", deleted
                ? "Terminal machine deleted."
                : "Can't delete this machine — one or more transactions still reference it.");
